...
Tanegységek:
- JavaScript
- Frontend készítésére szolgáló JavaScript framework
- Integrációs tesztelés
- Tartalomkezelő keretrendszer CMS használata
- Projektmunka
...
- Rétegelt architektúra és ORM a gyakorlatban
- A REST szoftverarchitektúra alapjai és REST API kiszolgáló készítése
- Integrációs tesztelés
- Projektmunka
